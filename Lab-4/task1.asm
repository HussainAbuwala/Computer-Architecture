...
#  input, and outputs the decoded bytes to standard output. But this program cannot handle padding characters at the end
#
...
bytesdone:
        ...
        li $v0,11			#print first character
        add $a0,$t4,0
        syscall
        
        li $v0,11			#print second character
        add $a0,$t5,0
        syscall
        
        li $v0,11			#print third character
        add $a0,$t6,0
        syscall
